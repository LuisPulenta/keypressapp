...
// class FlotaKmPreventivoScreen extends StatelessWidget {
//   const FlotaKmPreventivoScreen({super.key});

//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: const Text('Km y Preventivo'), centerTitle: true),
//       body: const Center(child: Text('Sin implementar')),
//     );
//   }
// }
...
class _FlotaKmPreventivoScreenState extends State<FlotaKmPreventivoScreen>
  ...
  Future<void> _getVehiculo() async {
    ...
    String vv = _vehiculo.codProducto.toString().trim();
    response2 = await ApiHelper.getKilometrajes(vv);
