...
class FlotaSiniestroAgregarScreen extends StatefulWidget {
  final Causante causante;
  const FlotaSiniestroAgregarScreen({super.key, required this.causante});

  @override
  _FlotaSiniestroAgregarScreenState createState() =>
      _FlotaSiniestroAgregarScreenState();
}

class _FlotaSiniestroAgregarScreenState
    extends State<FlotaSiniestroAgregarScreen> {
  //---------------------------------------------------------------
  //----------------------- Variables -----------------------------
  //---------------------------------------------------------------
