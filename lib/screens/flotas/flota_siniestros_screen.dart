...
class FlotaSiniestrosScreen extends StatefulWidget {
  const FlotaSiniestrosScreen({super.key});

  @override
  _FlotaSiniestrosScreenState createState() => _FlotaSiniestrosScreenState();
}

class _FlotaSiniestrosScreenState extends State<FlotaSiniestrosScreen> {
  //---------------------------------------------------------------
  //----------------------- Variables -----------------------------
  //---------------------------------------------------------------
  ...
  Widget _showLogo() {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        getImage(user: user, height: 70, width: 200),
        // Image.asset(
        //   "assets/logo.png",
        //   height: 70,
        //   width: 200,
