...
import 'package:keypressapp/screens/flotas/take_picture4.dart';
...
class FlotaSiniestroInfoScreen extends StatefulWidget {
  final VehiculosSiniestro siniestro;

  const FlotaSiniestroInfoScreen({super.key, required this.siniestro});

  @override
  _FlotaSiniestroInfoScreenState createState() =>
      _FlotaSiniestroInfoScreenState();
}

class _FlotaSiniestroInfoScreenState extends State<FlotaSiniestroInfoScreen> {
  //---------------------------------------------------------------
  //----------------------- Variables -----------------------------
  //---------------------------------------------------------------
