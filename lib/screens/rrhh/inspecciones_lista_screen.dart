...
class InspeccionesListaScreen extends StatefulWidget {
  const InspeccionesListaScreen({super.key});
...
class _InspeccionesListaScreenState extends State<InspeccionesListaScreen> {
  ...
  Future<void> _getInspecciones() async {
    ...
    response = await ApiHelper.getInspecciones(user.idUsuario.toString());
  ...
  void _goInfoInspeccion(VistaInspeccion e) async {
    ...
    String? result = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            InspeccionDuplicarScreen(user: user, vistaInspeccion: e),
      ),
    );
    if (result == 'yes') {
      _getInspecciones();
  ...
  void _addInspeccion() async {
    String? result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => InspeccionesScreen()),
    );
    if (result == 'yes') {
      _getInspecciones();
    }
